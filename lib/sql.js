        ...
        try {
            ...
            for (const column of columns) {
                if (!column instanceof Column) {
                    throw Error("Array must only consist of Columns");
                }
...
class Record {
    ...
    static add(tbl_name, columns, entries) {
        try {
            ...
            console.log(`INSERT INTO ${tbl_name} (${columnSet}) VALUES ${entrySet.join()}`);
    ...
    static update(tbl_name, entries = [], conditions = undefined) {
        // TODO
    }
